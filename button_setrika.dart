...
class Button_Setrika extends StatefulWidget {
  @override
  State<Button_Setrika> createState() => _Button_SetrikaState();
}

class _Button_SetrikaState extends State<Button_Setrika> {
  int weightKg = 0;
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          SizedBox(height: 16),
          Text(
            "Setelah pakaian selesai dicuci, biasanya layanan menyetrika pakaian menawarkan menyetrika dengan harga yang terjangkau.",
