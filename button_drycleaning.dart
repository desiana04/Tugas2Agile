...
class ButtonDrycleaning extends StatefulWidget {
  @override
  State<ButtonDrycleaning> createState() => _ButtonDrycleaningState();
}

class _ButtonDrycleaningState extends State<ButtonDrycleaning> {
  int weightKg = 0;
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          SizedBox(height: 16),
          Text(
            "Pakaian dicuci dengan bahan kimia khusus yang disebut pengering kering, dan kemudian diproses  dengan mesin khusus untuk mengeringkan pakaian.",
